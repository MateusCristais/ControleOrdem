 ...
 * @author Mateus
 */
@WebServlet(urlPatterns = {"/FuncionarioSalvar"})
public class FuncionarioSalvar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if(!request.getParameter("senha").equals(request.getParameter("senha2"))){
            ...
            RequestDispatcher rd = request.getRequestDispatcher("funcionarioNovo.jsp");
            ...
            if(tipo == 2){
                ...
                response.sendRedirect("funcionario.jsp?palavra=");
            ...
            //1 - INCLUSÃO    
                ...
                if(usuarioBusca != null){
                    ...
                    if(usuarioBusca != null){
                        ...
                        RequestDispatcher rd = request.getRequestDispatcher("funcionarios.jsp?palavra=");
                        rd.forward(request, response);
                    }
                }
            }
