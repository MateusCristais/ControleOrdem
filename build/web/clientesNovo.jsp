    ...
    <body id="corpo_fixo">
        ...
        <div id="conteudo_fixo">
            ...
            <div style="float:left; margin-left: 20px;">
                ...
                <table id="cadastros">
                    <form method="POST" action="UsuarioSalvar?tipo=${param.tipo}&codigo=${param.codigo}">
                        ...
                        <tr>
                            <td colspan="2">
                                <div>
                                    <a href="clientes.jsp?palavra=" title="Voltar"><img src="imagens/voltar.png" alt="Voltar" title="Voltar" /></a>
